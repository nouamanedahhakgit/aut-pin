...
TEMPLATE_DATA = {
    ...
    "images": {
        "main_img": {
            ...
            "position": {"top": 80, "left": 80}, "width": 440, "height": 440, "layer_order": 5,
    ...
    "elements": {
        ...
        "rule_line": {
            "type": "div", "position": {"top": 600, "left": 150}, "width": 300, "height": 2,
            "background_color": "#D4AF37", "z_index": 5
        },
        "chapter": {
            "type": "text", "text": "CHEF'S SPECIALS",
            "position": {"top": 560, "left": 0}, "width": 600, "height": 30,
        ...
        "title": {
            ...
            "position": {"top": 650, "left": 50}, "width": 500, "height": 120,
            "font_family": "'Playfair Display', serif", "font_size": 42, "font_weight": "700",
            "color": "#2C2C2C", "text_align": "center", "z_index": 10
        },
        "website": {
            "type": "text", "text": "{{domain}}", "position": {"top": 980, "left": 0}, "width": 600, "height": 40,
            "font_family": "'Lora', serif", "font_size": 16, "font_weight": "400",
