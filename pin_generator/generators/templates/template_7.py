...
TEMPLATE_DATA = {
    ...
    "elements": {
        "badge": {
            ...
            "border_radius": 25,
            "z_index": 20,
            "text_shadow": "0 0 12px rgba(255, 255, 255, 0.5)"
        },
        "floating_card": {
            "type": "div",
            "position": {"top": 539, "left": 49},
            "width": 638,
            "height": 270,
            "background_color": "rgba(255, 255, 255, 0.15)",
            "backdrop_blur": 20,
            "border": {"width": 1, "color": "rgba(255, 255, 255, 0.3)"},
            "box_shadow": "0 10px 39px 0 rgba(0, 0, 0, 0.3)",
            "border_radius": 25,
            "z_index": 10,
        },
        "title": {
