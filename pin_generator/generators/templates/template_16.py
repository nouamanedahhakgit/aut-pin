...
TEMPLATE_DATA = {
    ...
    "images": {
        "top_img": {
            ...
            "position": {"top": -100, "left": -50}, "width": 859, "height": 736, "layer_order": 1, "transform": "rotate(-5deg)"
        }
    },
    "elements": {
        "accent_panel": {
            "type": "div",
            "position": {"top": 552, "left": -100}, "width": 981, "height": 613,
            "background_color": "#1A1A1A", "transform": "rotate(-8deg)", "z_index": 5, "opacity": 0.95
        },
        "title": {
            "type": "text",
            "text": "UNLEASH THE<br>UMAMI BOMB",
            "position": {"top": 674, "left": 61}, "width": 613, "height": 221,
            "font_family": "'Bebas Neue', sans-serif", "font_size": 92, "font_weight": "400",
            "color": "#FFCC00", "text_align": "left", "line_height": 0.9, "z_index": 10, "transform": "rotate(-8deg)"
        },
        "subtitle": {
            "type": "text",
            "text": "The secret to bold flavors revealed",
            "position": {"top": 907, "left": 74}, "width": 491, "height": 49,
