...
TEMPLATE_DATA = {
    ...
    "elements": {
        "title_box": {
            "type": "div", "position": {"top": 80, "left": 0}, "width": 550, "height": 180,
            "background_color": "#E1306C", "z_index": 5
        },
        "title": {
            "type": "text", "text": "3 SECRETS TO<br>THE PERFECT BITE",
            "position": {"top": 110, "left": 30}, "width": 500, "height": 120,
            "font_family": "'Inter', sans-serif", "font_size": 42, "font_weight": "900",
            "color": "#FFFFFF", "text_align": "left", "line_height": 1.1, "z_index": 10
        },
        "n1": {
            "type": "div", "position": {"top": 350, "left": 50}, "width": 60, "height": 60,
            "background_color": "#FFD700", "border_radius": 30, "z_index": 5
        },
        "t1": {
            "type": "text", "text": "1", "position": {"top": 350, "left": 50}, "width": 60, "height": 60,
            "font_family": "'Inter', sans-serif", "font_size": 32, "font_weight": "900",
            "color": "#000", "text_align": "center", "z_index": 10
        },
        "n2": {
            "type": "div", "position": {"top": 450, "left": 50}, "width": 60, "height": 60,
            "background_color": "#FFD700", "border_radius": 30, "z_index": 5
        },
        "t2": {
            "type": "text", "text": "2", "position": {"top": 450, "left": 50}, "width": 60, "height": 60,
            "font_family": "'Inter', sans-serif", "font_size": 32, "font_weight": "900",
            "color": "#000", "text_align": "center", "z_index": 10
        },
        "n3": {
            "type": "div", "position": {"top": 550, "left": 50}, "width": 60, "height": 60,
            "background_color": "#FFD700", "border_radius": 30, "z_index": 5
        },
        "t3": {
            "type": "text", "text": "3", "position": {"top": 550, "left": 50}, "width": 60, "height": 60,
            "font_family": "'Inter', sans-serif", "font_size": 32, "font_weight": "900",
            "color": "#000", "text_align": "center", "z_index": 10
        },
        "website": {
            ...
            "color": "#FFFFFF", "text_align": "center", "text_shadow": "0 2px 4px rgba(0,0,0,0.5)", "z_index": 20
        }
    }
}
