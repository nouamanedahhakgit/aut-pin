...
TEMPLATE_DATA = {
    ...
    "images": {
        "top_image": {"description_prompt": "Chicken bacon ranch sandwich, food photography", "position": {"top": 0, "left": 0}, "width": 600, "height": 400, "layer_order": 1},
        "bottom_image": {"description_prompt": "Cross-section chicken bacon ranch sandwich", "position": {"top": 600, "left": 0}, "width": 600, "height": 467, "layer_order": 1},
    },
    "elements": {
        "text_band": {"type": "div", "position": {"top": 400, "left": 0}, "width": 600, "height": 200, "background_color": "#6D4C41", "z_index": 5},
        "subtitle": {
            "type": "text",
            "text": "Easy Homemade",
            ...
            "position": {"top": 415, "left": 0}, "width": 600, "height": 60, "font_family": "'Dancing Script', cursive", "font_size": 52, "font_weight": "700", "color": "#FFFFFF", "text_align": "center", "text_shadow": "2px 2px 4px rgba(0,0,0,0.3)", "z_index": 10,
        },
        "title": {
            "type": "text",
            "text": "CHOPPED CHICKEN<br>BACON RANCH SANDWICH",
            "text_prompt": "Generate content for title for recipe {{title}}. You are writing the TITLE for a Pinterest food pin. Format: exactly 2 lines, ALL CAPS, with <br> between lines. Each line 2–4 words. Output ONLY the replacement text for title including <br> (e.g. 'STREET CORN<br>CHICKEN BOWL'). Given the user's recipe title {{title}}, return only the title text with <br>.",
            "position": {"top": 475, "left": 20}, "width": 560, "height": 90, "font_family": "'Bebas Neue', sans-serif", "font_size": 42, "font_weight": "400", "color": "#FFFFFF", "text_align": "center", "line_height": 1, "text_shadow": "2px 2px 4px rgba(0,0,0,0.4)", "z_index": 10,
        },
        "time_badge": {
            "type": "text",
            "text": "in 10 minutes",
            ...
            "position": {"top": 565, "left": 200}, "width": 200, "height": 30, "font_family": "Arial, sans-serif", "font_size": 18, "font_weight": "bold", "color": "#FFFFFF", "text_align": "center", "text_shadow": "1px 1px 2px rgba(0,0,0,0.3)", "z_index": 10,
        },
    },
