...
def extract_style(config: dict) -> dict:
    ...
    return {
        ...
        "border_light": _get(c, "border_light", default="#E5E7EB"),
        "button_pin": _get(c, "button_pin", default="#E60023"),
        "gold": _get(c, "gold", default="#C9A96E"),
        "text_on_primary": _get(c, "text_on_primary", default="#FFFFFF"),
        "text_on_primary_muted": _get(c, "text_on_primary_muted", default="#B8B0A8"),
        "surface": _get(c, "surface", default="#F0E8DB"),
        "surface2": _get(c, "surface2", default="#EBE2D3"),
        "menu_link": _get(c, "menu_link", default="#6B6155"),
        "menu_link_hover": _get(c, "menu_link_hover", default="#C9A96E"),
